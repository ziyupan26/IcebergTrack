...
def imresize(arr, size, interp='bilinear'):
    ...
    filters = {'bilinear': Image.BILINEAR,
               ...
               'antialias': Image.Resampling.LANCZOS # replace ANTIALIAS with Resampling.LANCZOS
               }
...
def improve_scene(sub_templateg, alg=1, classify=False):
    ...
    ref = np.asarray(PIL.Image.fromarray(np.asarray(pd.read_pickle('/content/drive/MyDrive/icebergtrack/IceDT-main/AuxFiles/refhist.pkl'))))
